    ...
    return (
      <div className="space-y-6 max-w-5xl mx-auto animate-pulse">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Left Col: Biodata skeleton */}
          <div className="space-y-6">
            <div className="bg-white p-6 border border-slate-150 rounded-xl space-y-4">
              <div className="flex flex-col items-center py-4 border-b border-slate-100 gap-3">
              ...
              <div className="space-y-3">
                {[...Array(4)].map((_, i) => (
                  <div key={i} className="space-y-1.5">
                    <div className="h-2.5 bg-slate-150 rounded w-1/4" />
          ...
          {/* Right Col: Riwayat list skeleton */}
            ...
            <div className="bg-white p-6 border border-slate-150 rounded-xl space-y-4">
              ...
              <div className="space-y-4">
                {[...Array(3)].map((_, rowIdx) => (
                  <div key={rowIdx} className="border border-slate-150 rounded-xl p-4 space-y-3">
                          ...
                          {tx.detailTransaksi && tx.detailTransaksi.map((dt: any, dtIdx: number) => (
                            <div key={dt.id || dtIdx} className="flex justify-between items-start text-sm">
                              <div className="flex items-start gap-2">
                                ...
                                <div>
                                  <span className="font-semibold text-slate-700 block leading-tight">{dt.terapi?.nama || dt.namaManual || 'Layanan'}</span>
